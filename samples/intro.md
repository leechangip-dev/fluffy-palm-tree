...
반복 번역 작업을 자동화하면 시간과 비용을 절감할 수 있습니다. GitHub Actions와 연동 시 파일 수정 즉시 번역 및 검증이 실행됩니다.

## 주의사항

- API 키는 외부에 노출되지 않도록 GitHub Secret으로 관리하세요.
- 번역 결과 파일(`.en.md`, `.ja.md` 등)은 직접 수정하지 마세요. 소스 파일 수정 시 자동으로 덮어씁니다.
- 대용량 파일은 번역에 시간이 걸릴 수 있습니다.
